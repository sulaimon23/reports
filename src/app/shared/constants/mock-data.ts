...
export const MOCK_ASSETS: Asset[] = [
  ...
  { id: '5', name: 'LoadBalancer-01', ipAddress: '192.168.1.5', riskLevel: 'Critical', status: 'active', icon: 'server' },
  { id: '6', name: 'Application-Server-01', ipAddress: '192.168.1.6', riskLevel: 'Critical', status: 'active', icon: 'server' },
